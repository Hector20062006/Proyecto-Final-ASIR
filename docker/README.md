...
> **Actualización:** En el despliegue actual, los servicios de Python y web están sincronizados para usar la hora de Madrid en los registros y marcas de tiempo de acceso.
