...
<div class="container container-lg">
    ...
    <p>Busca un usuario y elimínalo del sistema. Ten cuidado, esta acción es irreversible.</p>

    <!-- Filtro de Búsqueda -->
    <form method="GET" action="borrar_usuario.php" class="filtro-form">
        <div class="form-row" style="align-items: flex-end;">
            ...
            <div class="btn-group">
                ...
                <?php if ($filtro !== ''): ?>
                    <a href="borrar_usuario.php" class="link-grow"><button type="button" class="btn-red btn-lg">Limpiar</button></a>
                <?php endif; ?>
            </div>
        </div>
    </form>
